...
class RawData(_object):
    ...
    __swig_setmethods__["modulationScheme"] = _roypy.RawData_modulationScheme_set
    __swig_getmethods__["modulationScheme"] = _roypy.RawData_modulationScheme_get
    if _newclass:
        modulationScheme = _swig_property(_roypy.RawData_modulationScheme_get, _roypy.RawData_modulationScheme_set)
...
_roypy.ProcessingFlag_WrappingThreshold_Float_swigconstant(_roypy)
ProcessingFlag_WrappingThreshold_Float = _roypy.ProcessingFlag_WrappingThreshold_Float

_roypy.ProcessingFlag_SpectreDebugMode_Int_swigconstant(_roypy)
...
IEvent_swigregister = _roypy.IEvent_swigregister
IEvent_swigregister(IEvent)

class IEventListener(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, IEventListener, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, IEventListener, name)
...
IEventListener_swigregister = _roypy.IEventListener_swigregister
IEventListener_swigregister(IEventListener)

class PythonEventListener(IEventListener):
    __swig_setmethods__ = {}
    for _s in [IEventListener]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, PythonEventListener, name, value)
    __swig_getmethods__ = {}
    for _s in [IEventListener]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, PythonEventListener, name)
    __repr__ = _swig_repr
    ...
    def __init__(self):
        if self.__class__ == PythonEventListener:
            ...
            _self = self
        this = _roypy.new_PythonEventListener(_self, )
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    def __disown__(self):
        ...
        return weakref_proxy(self)
PythonEventListener_swigregister = _roypy.PythonEventListener_swigregister
PythonEventListener_swigregister(PythonEventListener)
