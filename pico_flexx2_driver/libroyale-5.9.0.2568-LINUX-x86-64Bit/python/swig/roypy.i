...
%ignore royale::IntermediateData::operator= (IntermediateData dd);
%ignore royale::IntermediateData::IntermediateData(IntermediateData &&other);
%ignore royale::swap (IntermediateData &first, IntermediateData &second);
%ignore royale::DepthData::operator= (DepthData dd);
%ignore royale::DepthData::DepthData(DepthData &&other);
%ignore royale::swap (DepthData &first, DepthData &second);
%ignore royale::DepthImage::operator= (DepthImage dd);
%ignore royale::DepthImage::DepthImage(DepthImage &&other);
%ignore royale::swap (DepthImage &first, DepthImage &second);
%ignore royale::DepthIRImage::operator=(DepthIRImage dd);
%ignore royale::DepthIRImage::DepthIRImage(DepthIRImage &&other);
%ignore royale::swap (DepthIRImage &first, DepthIRImage &second);
%ignore royale::IRImage::operator= (IRImage dd);
%ignore royale::IRImage::IRImage(IRImage &&other);
%ignore royale::swap (IRImage &first, IRImage &second);
